# Contributing to JoChiel Ledgerly

If you are a JoChiel Ledgerly user and want to contribute to improving it _without
writing code_, there are several things you can do:

- **Inform us of issues** you face while using JoChiel Ledgerly by [raising issues](https://github.com/frappe/books/issues/new).
- **Add a language** you would like to use JoChiel Ledgerly in by [contributing translation](https://github.com/frappe/books/wiki/Contributing-Translations).
- **Share your thoughts** on JoChiel Ledgerly by joining our [Telegram group](https://t.me/frappebooks).
- **Use JoChiel Ledgerly** for your accounting requirements and tell people about it.

---

If you want to contribute code to JoChiel Ledgerly, please go through the following sections for tips and guidelines:
...
A few rules of thumb to ensure that you're contributing maintainable code to JoChiel Ledgerly:
...
- **Rebase don't merge**: Merge commits are ugly and should be used only to
  merge a large PR.
- **Format your code**: JoChiel Ledgerly uses `prettier` and `eslint` rules for code
...
We strive to make JoChiel Ledgerly as easy and simple to use as possible, and
